 ...
 */
#[Job(name: 'check_document_assignability', worker: 'sii_rcv', component: 'integration', package: 'billing')]
class CheckDocumentAssignabilityJob extends AbstractJob implements JobInterface
{
    ...
    public function check(
        ...
        try {
            ...
            $xmlResponse = $this->siiLazyWorker->consumeWebservice(
                ...
                function: 'consultarDocDteCedible',
                args: [
                    'rutEmisor' => $rut,
                    'dvEmisor' => $dv,
                    'tipoDoc' => $document,
